      ...
      <div className="footer-inner">
        <div className="footer-top">
          <div className="footer-brand">
            <img src="/images/logo.png" alt="HK Towing" className="footer-logo" loading="lazy" />
          ...
          <div className="footer-contact">
            <h4>Contact</h4>
            <a href="tel:+18646860012"><Phone size={14} /> (864) 686-0012</a>
            <a href="mailto:hani@hk-towing.com"><Mail size={14} /> hani@hk-towing.com</a>
            <a href="https://www.instagram.com/hktowingrecovering/" target="_blank" rel="noopener noreferrer">
        ...
        <div className="footer-bottom">
          ...
          <a href="tel:+18646860012" className="footer-cta">
